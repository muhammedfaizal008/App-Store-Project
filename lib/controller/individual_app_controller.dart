  ...
  class IndividualAppController with ChangeNotifier {
    ...
    // Constructor to fetch apps on initialization
    IndividualAppController() {
      fetchApps();
    }
    ...
    Future<void> fetchApps() async {
      try {
        ...
        log("Fetched Apps List: $_apps"); // Logging the fetched list of apps
